...
## Filtering the data
The real usefulness of the API with these data is filtering to get a very specific subset.  Here is an example of the URL you would use to get all data from 2011 onwards: https://www.st.nmfs.noaa.gov/ords/foss/trade_data/?q={"year":{"\$gt": 2010}}
<br>
