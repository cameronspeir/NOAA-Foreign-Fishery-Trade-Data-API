---
title: "Using Stata to Access the Fishery Foreign Trade Data API: Part 1, the Easy Stuff"
...
Then, create a an empty variable for each variable name - loop through the varnames in our local macro, invars.
